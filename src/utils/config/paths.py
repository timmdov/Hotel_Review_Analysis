...
TOPIC_MODELING_DIR = os.path.join(OUTPUTS_DIR, "topic_modeling")
...
STEP5_LEMMATIZED = os.path.join(DATA_INTERIM, "reviews_lemmatized.csv")
STEP6_NO_STOPWORDS = os.path.join(DATA_INTERIM, "reviews_no_stopwords.csv")
...
BER_TOPIC_RESULTS_CSV = os.path.join(TOPIC_MODELING_DIR, "bertopic_results.csv")

COLUMNS_TO_KEEP = ["HotelName", "Review", "Rating"] # columns to keep for step 1
COLUMNS_TO_KEEP_FOR_MODEL = ["Review_Clean", "Sentiment"] # columns to keep for model
